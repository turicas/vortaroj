test:
	...
	nosetests -dvs --with-coverage --cover-package vortaroj --with-yanc tests/test_*.py

test-x:
	@clear
	@python -c 'from __future__ import print_function; import sys; print(sys.version)'
	nosetests -dvsx --with-coverage --cover-package vortaroj --with-yanc tests/test_*.py
